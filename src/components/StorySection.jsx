...
const CHAPTERS = [
  ...
  {
    id: 'aventuras',
    tabName: '02 • Piloto & Tripulante',
    period: '2019 — 2027',
    title: 'Viajando por el Mundo y las Nubes',
    location: 'A más de 35.000 pies & en cada nuevo destino',
    quote: '"Mi partner en la tierra, en el aire y en cada horizonte."',
    story:
      'Entre cabinas de avión, despegues a miles de pies de altura, playas cálidas y calles llenas de color, hemos descubierto que no hay mejor destino que estar juntos. Odlan en los mandos como piloto y Jose como tripulante de cabina, somos el mejor equipo de vuelo del universo.',
    details: [
      { label: 'Nuestra tripulación', value: 'Piloto Odlan & Tripulante Jose' },
  ...
  {
    id: 'propuesta',
    tabName: '03 • Rumbo al Altar',
    period: 'Febrero 2027',
    title: 'Nuestra Historia Continúa ✨ 20.02.2027 ✨',
    location: 'Santiago de Chile',
    quote: '"Para siempre es solo el comienzo de nuestra historia."',
    story:
      'Después de más de siete años de complicidad, risas y vuelos compartidos, decidimos dar el paso definitivo que une nuestras vidas. Con la emoción a flor de piel y el corazón lleno de amor, estamos listos para celebrar nuestro matrimonio y decir "Sí, Acepto" rodeados de quienes más queremos.',
    details: [
      { label: 'Fecha del gran despegue', value: 'Sábado 20 de Febrero de 2027' },
      { label: 'Destino', value: 'Una vida entera para amarnos' },
      { label: 'La certeza', value: 'Te amo infinito bb ❤️' },
    ],
